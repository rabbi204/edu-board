            ...
            <div class="panel-body">
                <form class="bs-example form-horizontal" action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10"><input type="password" name="new_pass" class="form-control"  /></div>
                    </div>

                    <div class="form-group">
                        <label class="col-lg-2 control-label">Confirm Password</label>
                        <div class="col-lg-10"><input type="password" name="confirm_pass" class="form-control"  /></div>
                    </div>
